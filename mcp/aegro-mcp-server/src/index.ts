...
server.tool(
  'aegro_get_farm',
  'Get farm/property information associated with the API key. Returns farm name, total area, and key.',
  {},
  async () => {
    try {
...
server.tool(
  'aegro_get_element',
  'Get a specific element (seed, fertilizer, defensive, service, etc.) by its key.',
  {
...
server.tool(
  'aegro_filter_elements',
  'Filter and list elements (seeds, fertilizers, defensives, services, items, pests) with pagination.',
  {
...
server.tool(
  'aegro_get_company',
  'Get a specific company/supplier by its key.',
  {
...
server.tool(
  'aegro_filter_companies',
  'Filter and list companies/suppliers with pagination.',
  {
...
server.tool(
  'aegro_get_glebe',
  'Get a specific field/area (talhão) by its key.',
  {
...
server.tool(
  'aegro_filter_glebes',
  'Filter and list fields/areas (talhões) with pagination.',
  {
...
server.tool(
  'aegro_get_crop',
  'Get a specific crop/season (safra) by its key.',
  {
...
server.tool(
  'aegro_filter_crops',
  'Filter and list crops/seasons (safras) with pagination.',
  {
...
server.tool(
  'aegro_get_crop_glebe',
  'Get a specific crop-glebe (área de safra) by its key.',
  {
...
server.tool(
  'aegro_filter_crop_glebes',
  'Filter and list crop-glebes (áreas de safra) for a specific crop.',
  {
...
server.tool(
  'aegro_get_asset',
  'Get a specific asset (machine, implement, vehicle, pivot, etc.) by its key.',
  {
...
server.tool(
  'aegro_filter_assets',
  'Filter and list assets (machines, implements, vehicles, pivots, etc.) with pagination.',
  {
...
server.tool(
  'aegro_create_garner',
  'Create a new garner/silo asset.',
  {
...
server.tool(
  'aegro_create_pivot',
  'Create a new pivot/irrigation asset.',
  {
...
server.tool(
  'aegro_create_immobilized',
  'Create a new immobilized/fixed asset.',
  {
...
server.tool(
  'aegro_get_asset_maintenance',
  'Get a specific asset maintenance record by its key.',
  {
...
server.tool(
  'aegro_filter_asset_maintenances',
  'Filter and list asset maintenance records with pagination.',
  {
...
server.tool(
  'aegro_create_asset_maintenance',
...
server.tool(
  'aegro_get_asset_fuel_supply',
  'Get a specific fuel supply record by its key.',
  {
...
server.tool(
  'aegro_filter_asset_fuel_supplies',
  'Filter and list fuel supply records with pagination.',
  {
    assetKeys: z.array(z.string()).optional().describe('Filter by asset keys'),
    startDate: z.string().optional().describe('Start date (YYYY-MM-DD)'),
    endDate: z.string().optional().describe('End date (YYYY-MM-DD)'),
...
server.tool(
  'aegro_create_asset_fuel_supply',
...
server.tool(
  'aegro_get_activity',
  'Get a specific activity by its key.',
  {
...
server.tool(
  'aegro_filter_activities',
  'Filter and list activities with pagination.',
  {
...
server.tool(
  'aegro_get_activity_plan',
  'Get the plan for a specific activity.',
  {
...
server.tool(
  'aegro_get_activity_plan_by_key',
  'Get a specific activity plan by its key.',
  {
...
server.tool(
  'aegro_get_activity_realization',
  'Get a specific activity realization by its key.',
  {
...
server.tool(
  'aegro_filter_activity_realizations',
  'Filter and list activity realizations with pagination.',
  {
    activityKeys: z.array(z.string()).optional().describe('Filter by activity keys'),
    cropGlebeKeys: z.array(z.string()).optional().describe('Filter by crop-glebe keys'),
    startDate: z.string().optional().describe('Start date (YYYY-MM-DD)'),
...
server.tool(
  'aegro_get_harvest_log',
  'Get a specific harvest log by its key.',
  {
...
server.tool(
  'aegro_filter_harvest_logs',
  'Filter and list harvest logs for a crop with pagination.',
  {
...
server.tool(
  'aegro_create_harvest_log',
  'Create a new harvest log for a crop.',
  {
    cropKey: z.string().describe('The crop key'),
...
server.tool(
  'aegro_get_harvest_discounts',
  'Get harvest discount configurations for a crop.',
  {
    cropKey: z.string().describe('The crop key'),
  },
  async ({ cropKey }) => {
...
server.tool(
  'aegro_get_stock_location',
  'Get a specific stock location by its key.',
  {
...
server.tool(
  'aegro_filter_stock_locations',
  'Filter and list stock locations with pagination.',
  {
...
server.tool(
  'aegro_get_stock_item',
  'Get a specific stock item by its key.',
  {
...
server.tool(
  'aegro_filter_stock_items',
  'Filter and list stock items with pagination.',
  {
...
server.tool(
  'aegro_get_stock_log',
  'Get a specific stock movement log by its key.',
  {
...
server.tool(
  'aegro_filter_stock_logs',
  'Filter and list stock movement logs with pagination.',
  {
    stockLocationKeys: z.array(z.string()).optional().describe('Filter by stock location keys'),
    elementKeys: z.array(z.string()).optional().describe('Filter by element keys'),
...
server.tool(
  'aegro_get_bank_account',
  'Get a specific bank account by its key.',
  {
...
server.tool(
  'aegro_filter_bank_accounts',
  'Filter and list bank accounts with pagination.',
  {
    searchText: z.string().optional().describe('Search text'),
    requiredPageNumber: z.number().optional().default(1).describe('Page number'),
    maximumItemsPerPageCount: z.number().optional().default(20).describe('Items per page'),
...
server.tool(
  'aegro_get_bill',
  'Get a specific bill (payable/receivable) by its key.',
  {
...
server.tool(
  'aegro_filter_bills',
  'Filter and list bills (payables/receivables) with pagination.',
  {
...
server.tool(
  'aegro_get_installment',
  'Get a specific installment by its key.',
  {
...
server.tool(
  'aegro_filter_installments',
  'Filter and list installments with pagination.',
  {
...
server.tool(
  'aegro_save_installment',
  'Create or update an installment.',
  {
...
server.tool(
  'aegro_delete_installments',
  'Delete one or more installments.',
  {
...
server.tool(
  'aegro_get_financial_category',
  'Get a specific financial category by its key.',
  {
...
server.tool(
  'aegro_filter_financial_categories',
  'Filter and list financial categories with pagination.',
  {
    billTypes: z.array(z.enum(['PAYABLE', 'RECEIVABLE'])).optional().describe('Filter by bill types'),
...
server.tool(
  'aegro_create_financial_category',
...
server.tool(
  'aegro_get_element_financial_categories',
  'Get financial categories associated with an element.',
  {
...
server.tool(
  'aegro_get_purchase_order',
  'Get a specific purchase order by its key.',
  {
...
server.tool(
  'aegro_filter_purchase_orders',
  'Filter and list purchase orders with pagination.',
  {
    companyKeys: z.array(z.string()).optional().describe('Filter by company keys'),
...
server.tool(
  'aegro_get_apportionment',
  'Get a specific apportionment by its key.',
  {
...
server.tool(
  'aegro_filter_apportionments',
  'Filter and list apportionments with pagination.',
  {
    cropGlebeKeys: z.array(z.string()).optional().describe('Filter by crop-glebe keys'),
    requiredPageNumber: z.number().optional().default(1).describe('Page number'),
    maximumItemsPerPageCount: z.number().optional().default(20).describe('Items per page'),
...
server.tool(
  'aegro_get_weather_log',
  'Get a specific weather log by its key.',
  {
...
server.tool(
  'aegro_filter_weather_logs',
  'Filter and list weather logs with pagination.',
  {
    glebeKeys: z.array(z.string()).optional().describe('Filter by glebe keys'),
    startDate: z.string().optional().describe('Start date (YYYY-MM-DD)'),
    endDate: z.string().optional().describe('End date (YYYY-MM-DD)'),
...
server.tool(
  'aegro_filter_tags',
  'Filter and list tags with pagination.',
  {
    searchText: z.string().optional().describe('Search text'),
    requiredPageNumber: z.number().optional().default(1).describe('Page number'),
    maximumItemsPerPageCount: z.number().optional().default(20).describe('Items per page'),
...
server.tool(
  'aegro_get_climate_record',
  'Get a specific climate record by its key.',
  {
...
server.tool(
  'aegro_filter_climate_records',
  'Filter and list climate records with pagination.',
  {
    glebeKeys: z.array(z.string()).optional().describe('Filter by glebe keys'),
    startDate: z.string().optional().describe('Start date (YYYY-MM-DD)'),
    endDate: z.string().optional().describe('End date (YYYY-MM-DD)'),
...
server.tool(
  'aegro_filter_catalog_elements',
  'Filter and list public catalog elements (seeds, fertilizers, defensives, etc.).',
  {
    searchText: z.string().optional().describe('Search text'),
    categories: z.array(z.enum(['DEFENSIVE', 'FERTILIZER', 'ITEM', 'SEED', 'SERVICE', 'PEST'])).optional().describe('Filter by categories'),
...
server.tool(
  'aegro_filter_catalog_pests',
  'Filter and list public catalog pests.',
  {
    searchText: z.string().optional().describe('Search text'),
    requiredPageNumber: z.number().optional().default(1).describe('Page number'),
    maximumItemsPerPageCount: z.number().optional().default(20).describe('Items per page'),
